...
import { User, Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, CheckSquare } from "lucide-react";
        ...
        >
          <div className="flex items-center justify-center mb-6">
            <div className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-primary-100 to-accent-100 rounded-full">
              ...
              <span className="text-sm font-medium text-primary-600">Join TaskFlow today!</span>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-center text-gray-800 mb-8">Create your free account</h2>
